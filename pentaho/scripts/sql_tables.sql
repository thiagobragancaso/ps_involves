...
CREATE TABLE dw_involves.ft_disponibilidade (
  ...
  QTD_PRESENCA int,
  CONSTRAINT PRIMARY KEY (SK_DIM_PDV, SK_DIM_LINHA_PRODUTO, SK_DIM_CALENDARIO),
  CONSTRAINT FOREIGN KEY (SK_DIM_PDV) REFERENCES DIM_PDV(SK_DIM_PDV),
  CONSTRAINT FOREIGN KEY (SK_DIM_LINHA_PRODUTO) REFERENCES DIM_LINHA_PRODUTO(SK_DIM_LINHA_PRODUTO),
  CONSTRAINT FOREIGN KEY (SK_DIM_CALENDARIO) REFERENCES DIM_CALENDARIO(SK_DIM_CALENDARIO)
);
...
CREATE TABLE dw_involves.ft_disponibilidade_agg (
  ...
  SK_DIM_CALENDARIO int,
  QTD_PRESENCA int,
  CONSTRAINT PRIMARY KEY (SK_DIM_PDV, SK_DIM_CALENDARIO),
  CONSTRAINT FOREIGN KEY (SK_DIM_PDV) REFERENCES DIM_PDV(SK_DIM_PDV),
  CONSTRAINT FOREIGN KEY (SK_DIM_CALENDARIO) REFERENCES DIM_CALENDARIO(SK_DIM_CALENDARIO)
);
